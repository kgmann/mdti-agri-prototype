...
- **Indicators.** Monitoring indicators in the spirit of the terms of reference's monitoring framework: registered farmers, share of women and young people, cooperative membership, mapped and active area, access to inputs and subsidies, input-credit repayment, score distribution, production by crop, and alert read rates, overall and per department.
